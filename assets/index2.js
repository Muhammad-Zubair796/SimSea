window.addEventListener('load', function() {
    ...
    class Player {
        constructor(game) {
            ...
            this.maxSpeed = 2;
            this.projectiles = [];
            this.image = document.getElementById('player'); // ID matches fixed HTML
            this.powerUp = false;
            this.powerUpTimer = 0;
    ...
    class Projectile {
        constructor(game, x, y) {
            ...
            this.image = document.getElementById('projectile'); // fixed ID
            this.damage = 1;
        }
        update() {
    ...
    class Particle {
        constructor(game, x, y) {
            ...
            this.x = x;
            this.y = y;
            this.image = document.getElementById('particle'); // fixed ID
